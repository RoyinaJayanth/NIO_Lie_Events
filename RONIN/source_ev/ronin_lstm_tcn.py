...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, help='Configuration file [Default: {}]'.format(default_config_file),
                        default='/home/royinakj/ronin/ronin_tcn/config.json')#default_config_file 
    ...
    parser.add_argument('--data_dir', type=str, default='/home/royinakj/oxoid_data/test_processed/unseen', help='Directory for data files if different from list path.')
    ...
    parser.add_argument('--out_dir', type=str, default="output/test_tcn_oxoid")
    ...
    test_cmd.add_argument('--test_list', type=str, default="/home/royinakj/oxoid_data/test_processed/unseen/all_ids.txt")
    test_cmd.add_argument('--model_path', type=str, default="/home/royinakj/ronin/ronin_tcn/checkpoints/ronin_tcn_checkpoint.pt")
